...
- **Dokąd odsyła:** ruiny Przedzamcza, dziewiąte bicie (21:00) — wybór strony (Albrecht / Bażyński), oddanie listu. **Brama Albrechta = wypowiedzenie motta Zakonu** (odszyfrowane z Z11).
...
*At Przedzamcze, where the fortress stands in ruin, the ninth bell will bring the Komtur into the dark — and across from him, the rebels' chairman. Between them, a single choice: into whose hands your sealed letter goes.*
...
- **Dziewiąte bicie / Przedzamcze / nie Tuba Dei** — jak `miasto-6-Z7` (anachronizm dzwonu).
