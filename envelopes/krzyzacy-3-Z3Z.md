...
- **Godzina 21:00 = AMBIENT, nie bramka [Oskar 2026-06-03].** Jordan o niej mówi swoim ludziom TR — KZ mogą ją usłyszeć w tle (ładny obraz: obie strony znają godzinę), ale **nie muszą jej „wyciągać"**. KZ dostają 21:00 od **Albrechta** (handler, `albrecht-actor-card §STEP K3` — „come at the ninth bell"). Z3Z jej nie gatekeeper'uje. *(Wcześniejsze „wyciągnięcie godziny od Jordana" z meta-kartki/zamek-lista = ZDEZAKTUALIZOWANE — patrz §Do zaktualizowania.)*
