...
> Decyzje ramowe stoją; brakuje **treści**. Nic z poniższego nie jest jeszcze napisane:

- **K2-K** (koperta krzyżacka): Pula B plotek + Z2 → Albrecht
- **Z3Z** (infiltracja Piccolo): pełna mechanika + tekst koperty
- **Z8 / Z9 / Z10**: treść (Z10 wymaga researchu polichromii na miejscu — 🚶)
- **Z11** (finał): szyfrogram + rama narracyjna
- **Skrypt Albrechta F2A** (Zosia) + **KF wariant krzyżacki**

---

> 📦 **Wcześniejszy materiał roboczy** (propozycje rozdzielenia, postać kontaktowa, rezerwuar odrzuconego plot-twistu, materiały wiki, rekomendacja procesu) → `todo/archive/stary-material.md`. Wszystkie tamte pytania są rozstrzygnięte przez decyzje ramowe wyżej.
