...
🟡 Z3Z — infiltracja Piccolo .... koperta gracza draft [2026-06-03]: model Oskara — GŁÓWNE=obserwacja (kolor szaty+chochla→klucz Z11), łup=ZJEDZENIE prowiantu (kupon; fabuła oblężenia), godzina 20:30=ambient (od Albrechta). Jednokopertowe (rozkaz Albrechta „— A."), loop trywialny. Zostaje: review + mechanika kuponu + ew. plotki B  [envelopes/krzyzacy-3-Z3Z.md]
