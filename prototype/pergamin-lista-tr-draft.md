# Prop — Order's Intelligence List of the Secret Council (Z3 pergamin) — draft

> **Language:** English (player-facing). Planning notes in Polish below.
> **Status:** draft [2026-06-01] — awaiting Oskar's review. Canon + decisions → `puzzles/z3-lista-tr-spec.md`.
> **What it is:** the parchment the group steals from Komtur Albrecht (Zosia) in Z3.
> **In-world framing:** the Teutonic Order's working intelligence list of who sits on the Secret Council, compiled from informants' reports. Grounded in real sources (the "N.N. to Herr Nicolaus" denunciations, Toruń 7–8 Jan 1454).
> **Key layer:** this draft is the NAME LIST only. Whether the parchment *encodes a cipher key* depends on Oskar's Decision #1 (Model A vs B) — that layer is attached later, list is identical either way.

---

## PROP TEXT — Z3 parchment (player reads this)
...
**Stylizacja:** finalny pergamin (Fraktur/UnifrakturMaguntia, łacina/niemiecki, część wpisów skreślona ręką pisarza) → po dry-runie, zgodnie z roadmapą. Tu wersja funkcjonalna.
