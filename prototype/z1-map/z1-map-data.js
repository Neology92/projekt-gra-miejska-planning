...
const Z1_GLYPHS = {
  // N-zone: directional triangles — H=W=22.5, centroid=(16,16); enlarged 1.25× to offset 16px glyph window
  N01: '<polygon points="16,1 27,23.5 5,23.5" fill="none" stroke="#2a1f0e" stroke-width="2.4" stroke-linejoin="round" stroke-linecap="round"/>',
  N02: '<polygon points="16,31 5,8.5 27,8.5" fill="none" stroke="#2a1f0e" stroke-width="2.4" stroke-linejoin="round" stroke-linecap="round"/>',
  N03: '<polygon points="1,16 23.5,5 23.5,27" fill="none" stroke="#2a1f0e" stroke-width="2.4" stroke-linejoin="round" stroke-linecap="round"/>',
  N04: '<polygon points="31,16 8.5,5 8.5,27" fill="none" stroke="#2a1f0e" stroke-width="2.4" stroke-linejoin="round" stroke-linecap="round"/>',
